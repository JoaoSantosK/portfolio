...
const ProjectCard = ({title, description, desktopImg, mobileImg, link}) => {
    return(
            <div className="project-card">
                <div className="project-images">
                    <img src={desktopImg} alt={`${title} desktop view`} className="desktop-img" />
                    <img src={mobileImg} alt={`${title} mobile view`} className="mobile-img" />
                </div>

                <div className="project-info">
                    <h1>{title}</h1>
                    <p>{description}</p>
                    <a href={link} target="_blank" rel="noopener noreferrer" className="project-link">Ver no GitHub</a>
                </div>
